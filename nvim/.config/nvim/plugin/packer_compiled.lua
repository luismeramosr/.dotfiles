...
_G.packer_plugins = {
  ...
  base46 = {
    ...
    loaded = true,
    path = "/home/luisr/.local/share/nvim/site/pack/packer/start/base46",
  ...
  ["bufferline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/luisr/.local/share/nvim/site/pack/packer/opt/bufferline.nvim",
  ...
  extensions = {
    loaded = true,
    path = "/home/luisr/.local/share/nvim/site/pack/packer/start/extensions",
